...
class ChatGPTBot(Bot, OpenAIImage):
    ...
    def reply(self, query, context=None):
        ...
        if context.type == ContextType.TEXT:
            ...
            reply_content = self.reply_text(session, context, api_key, args=new_args)
            logger.debug(
    ...
    def reply_text(self, session: ChatGPTSession, context: Context = None, api_key=None, args=None, retry_count=0) -> dict:
        """
        ...
        try:
            ...
            if need_retry:
                ...
                return self.reply_text(session, context, api_key, args, retry_count + 1)
            else:
                return result
